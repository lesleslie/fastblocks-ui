...
FastBlocks UI is functionally complete for the current plan. What remains is release hygiene and optional polish.
...
- [ ] Broaden the component catalog.
- [ ] Add PWA lifecycle behavior to FastBlocks UI itself.
- [ ] Add framework-specific abstractions that weaken the HTML/CSS-first model.
